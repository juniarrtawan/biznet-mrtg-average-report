...
url_login = "http://mrtg-branch.biznetnetworks.com/cacti/graph_view.php"
...
def extract_text(i):
	...
	img_crop_data = img.crop((720, 420, 790, 469))   #adjust this line to get correct cropped area for average value
